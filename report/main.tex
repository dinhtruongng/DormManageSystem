...
The interface figures below are real screenshots captured from the running demo, replacing the placeholder wireframes that were used to define layout intent before implementation. The implementation follows the design intent of the original wireframes: a persistent role-aware shell, status badges, searchable tables, and workflow queues.
...
\subsection{Implemented Screenshots}
The demo is implemented. The placeholder wireframes have been replaced with real screenshots captured from the running system: the login page, admin dashboard, room assignment recommendation screen, student payment upload screen, finance payment review screen, and check-out settlement screen. These screenshots, shown in the following subsections, reflect the implemented user interface and the role-aware design intent.

\subsection{Admin Dashboard}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{figures/screenshots/02-dashboard.png}
\caption{Administrative dashboard of the running demo}
\end{figure}

\subsection{Payment Review}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{figures/screenshots/05-payment-review.png}
\caption{Finance payment review queue of the running demo}
\end{figure}

The remaining implemented screens are shown in Appendix~\ref{sec:implemented-screens}.
...
\appendix
\section{Implemented Screens}\label{sec:implemented-screens}

This appendix collects the remaining screenshots from the running demo, complementing the dashboard and payment review screens in Section~8. Together they show the implemented role-aware interface that replaced the original placeholder wireframes.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{figures/screenshots/01-login.png}
\caption{Login page with role-aware redirect and demo account hints}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{figures/screenshots/03-assignment.png}
\caption{Bed assignment recommendation screen with policy-based scoring}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{figures/screenshots/04-payment-upload.png}
\caption{Student payment evidence upload form}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.62\textheight,keepaspectratio]{figures/screenshots/06-checkout.png}
\caption{Check-out settlement screen (inspection, damage fee, bed release)}
\end{figure}
